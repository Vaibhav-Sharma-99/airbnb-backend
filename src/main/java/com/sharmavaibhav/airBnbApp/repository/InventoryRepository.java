...
//TODO i changed the method name and signature, check if usages have errors
    ...
    @Query("""
            ...
            WHERE i.room.id = :roomId
                ...
                AND (i.totalCount - i.bookedCount - i.reservedCount) >= :roomsCount
            """)
    @Lock(LockModeType.PESSIMISTIC_WRITE) //so no one else can book at the same time till payment pending
    //lock released when @Transactional method ends
